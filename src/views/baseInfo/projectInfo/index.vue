  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="项目状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择项目状态" clearable filterable >
          <el-option
    ...
    <el-table v-loading="loading" :data="projectInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="项目名" align="center" prop="name"  width="200" />
      <el-table-column label="负责人" align="center" prop="leader"  width="200" />
      <el-table-column label="开始日期" align="center" prop="startDate"  width="200" >
      ...
      <el-table-column label="项目状态" align="center" prop="status" :formatter="statusFormat"  width="200" />
    ...
    <!-- 添加或修改项目维护对话框 -->
    <el-dialog v-if="open" :title="title" v-model="open" width="600px" append-to-body>
