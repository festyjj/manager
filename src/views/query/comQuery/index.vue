    ...
    <el-table v-loading="loading" :data="comQueryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200" >
        <template #default="scope">
          <el-button  text  @click="handleUpdate(scope.row)" v-hasPermi="['query:comQuery:edit']">修改</el-button>
          <el-button  text  @click="handleDelete(scope.row)" v-hasPermi="['query:comQuery:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
