<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button  type="primary" plain   @click="handleAdd" v-hasPermi="['cms:comment:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button  type="success" plain   :disabled="single" @click="handleUpdate" v-hasPermi="['cms:comment:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button  type="danger" plain   :disabled="multiple" @click="handleDelete" v-hasPermi="['cms:comment:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button  type="warning" plain   @click="handleExport" v-hasPermi="['cms:comment:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="commentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="点赞数" align="center" prop="goodNum"  width="200" />
      <el-table-column label="评论人" align="center" prop="createBy" :formatter="createByFormat"  width="200" />
      <el-table-column label="评论时间" align="center" prop="createTime"  width="200" >
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200" >
        <template #default="scope">
          <el-button  text @click="handleReplay(scope.row)" v-hasPermi="['cms:comment:edit']">回复</el-button>
          <el-button  text  @click="handleUpdate(scope.row)" v-hasPermi="['cms:comment:edit']">修改</el-button>
          <el-button  text  @click="handleDelete(scope.row)" v-hasPermi="['cms:comment:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
