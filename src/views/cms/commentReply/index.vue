<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button  type="primary" plain   @click="handleAdd" v-hasPermi="['cms:commentReply:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button  type="success" plain   :disabled="single" @click="handleUpdate" v-hasPermi="['cms:commentReply:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button  type="danger" plain   :disabled="multiple" @click="handleDelete" v-hasPermi="['cms:commentReply:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button  type="warning" plain   @click="handleExport" v-hasPermi="['cms:commentReply:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="commentReplyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="回复人" align="center" prop="createBy" :formatter="createByFormat"  width="200" />
      <el-table-column label="回复时间" align="center" prop="createTime"  width="200" >
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200" >
        <template #default="scope">
          <el-button  text  @click="handleUpdate(scope.row)" v-hasPermi="['cms:commentReply:edit']">修改</el-button>
          <el-button  text  @click="handleDelete(scope.row)" v-hasPermi="['cms:commentReply:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
