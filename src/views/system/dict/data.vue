<template>
   <div class="app-container">
      ...
      <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
         ...
         <el-table-column label="字典编码" align="center" prop="dictCode"  width="200" />
         <el-table-column label="字典标签" align="center" prop="dictLabel" width="200" >
            <template #default="scope">
               <span v-if="(scope.row.listClass == '' || scope.row.listClass == 'default') && (scope.row.cssClass == '' || scope.row.cssClass == null)">{{ scope.row.dictLabel }}</span>
               <el-tag v-else :type="scope.row.listClass == 'primary' ? '' : scope.row.listClass" :class="scope.row.cssClass">{{ scope.row.dictLabel }}</el-tag>
            </template>
         </el-table-column>
         <el-table-column label="字典键值" align="center" prop="dictValue"  width="200" />
         <el-table-column label="字典排序" align="center" prop="dictSort"  width="200" />
