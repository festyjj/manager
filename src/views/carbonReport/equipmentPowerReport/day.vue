<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="equipmentPowerReportList">
      ...
      <el-table-column label="单位碳排放" align="center" prop="carbonEmission" :formatter="carbonEmissionFormat" width="200" />
      <el-table-column label="总碳排放" align="center" prop="totalCarbonEmission" :formatter="totalCarbonEmissionFormat" width="200" />
    </el-table>
