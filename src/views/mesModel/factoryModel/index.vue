<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain @click="handleAdd" v-hasPermi="['mesModel:factoryModel:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="factoryModelList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="生产线名称" align="center" prop="productLineName" width="200" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200" >
        <template #default="scope">
          <el-button text @click="handleUpdate(scope.row)" v-hasPermi="['mesModel:factoryModel:edit']">修改
          </el-button>
          <el-button text @click="handleDelete(scope.row)" v-hasPermi="['mesModel:factoryModel:remove']">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog v-if="open" :title="title" v-model="open" width="1000px" append-to-body>
      <el-form ref="form" :model="form" :inline="true" :rules="rules" label-width="100px">
        ...
        <el-row :gutter="10" class="mb8">
                    <el-col :span="1.5">
                      <el-button  type="primary"   @click="handleAddMesFactoryModelDetail">添加</el-button>
                    </el-col>
<!--          <el-col :span="1.5">-->
<!--            <el-button type="primary" @click="showDesign">设计</el-button>-->
<!--          </el-col>-->
          <el-col :span="1.5">
            <el-button type="danger" @click="handleDeleteMesFactoryModelDetail">删除</el-button>
          </el-col>
        </el-row>
        <el-table :data="mesFactoryModelDetailList"
...
<!--    &lt;!&ndash;    流程&ndash;&gt;-->
<!--    <el-dialog v-model="openBpmn" width="80%">-->
<!--      <bpmn-component @save="bpmnSave"></bpmn-component>-->
<!--    </el-dialog>-->
...
export default {
  ...
  methods: {
    bpmnSave(call) {
      this.openBpmn = !this.openBpmn

      call.forEach(item => {
        this.mesFactoryModelDetailList.push(item);
