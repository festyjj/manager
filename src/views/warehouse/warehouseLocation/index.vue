<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item>
        <el-button  type="primary"   @click="handleQuery">搜索
        </el-button>
    ...
    <el-table v-loading="loading" :data="warehouseLocationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="库区名称" align="center" prop="regionName" width="200" />
      <el-table-column label="库位编码" align="center" prop="code" width="200" />
      <el-table-column label="库位名称" align="center" prop="name" width="200" />
      ...
      data() {
        return {
          ...
          rules: {
            ...
            name: [
              {max: 20, message: "库位名称最多20个字符", trigger: "blur"}
            ],
          }
        };
      },
      created() {
        this.queryParams.regionId = this.$route.query.id
        this.getList();
      },
      methods: {
        /** 查询库位管理列表 */
        ...
        reset() {
          ...
          this.form.regionId = this.$route.query.id;
          this.resetForm("form");
        },
        /** 搜索按钮操作 */
        handleQuery() {
        ...
        handleDelete(row) {
          ...
          this.$confirm('是否确认删除库位管理编号为"' + ids + '"的数据项?', "警告", {
        ...
        handleExport() {
          ...
          this.$confirm('是否确认导出所有库位管理数据项?', "警告", {
            confirmButtonText: "确定",
            cancelButtonText: "取消",
            type: "warning"
          }).then(function () {
