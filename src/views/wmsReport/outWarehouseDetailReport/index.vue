  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="物料" prop="materialId">
        <el-input v-model="queryParams.materialId" placeholder="请输入物料" clearable  @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button  type="warning" plain   @click="handleExport" v-hasPermi="['wmsReport:outWarehouseDetailReport:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="outWarehouseDetailReportList">
      ...
      <el-table-column label="出库数量" align="center" prop="outQuantity"  width="200" />
    </el-table>
