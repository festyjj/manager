  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="90px">
      <el-form-item label="订单编号" prop="purchasePlanNo">
        <el-input v-model="queryParams.purchasePlanNo" placeholder="请输入订单编号" clearable
    ...
    <el-dialog :title="title" v-model="open" width="1000px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="90px" :inline="true">
        ...
        <el-table :data="scmSaleOrderDetailList" :row-class-name="rowScmSaleOrderDetailIndex"
          ...
          <el-table-column label="产品" prop="materialName"  width="200" ></el-table-column>
          ...
          <el-table-column label="订货数量" prop="quantity"  width="200" ></el-table-column>
