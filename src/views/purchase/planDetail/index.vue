<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="计划id" prop="purchasePlanId">
        <el-input
          v-model="queryParams.purchasePlanId"
          placeholder="请输入计划id"
          clearable
    ...
    <el-table v-loading="loading" :data="planDetailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="计划id" align="center" prop="purchasePlanId"  width="200" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="计划id" prop="purchasePlanId">
          <el-input v-model="form.purchasePlanId" placeholder="请输入计划id" />
        </el-form-item>
        <el-form-item label="物料id" prop="materialId">
...
<script>
import { listPlanDetail, getPlanDetail, delPlanDetail, addPlanDetail, updatePlanDetail, exportPlanDetail } from "@/api/purchase/planDetail";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除采购计划详细编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有采购计划详细数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
