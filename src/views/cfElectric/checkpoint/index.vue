  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="100px">
      <el-form-item label="检测点名称" prop="name">
        <el-input v-model="queryParams.name" placeholder="请输入检测点名称" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="检测点地址" prop="address">
        <el-input v-model="queryParams.address" placeholder="请输入检测点地址" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="checkpointList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="检测点名称" align="center" prop="name"  width="200" />
      <el-table-column label="检测点地址" align="center" prop="address"  width="200" />
      <el-table-column label="实时功率" align="center" prop="rtPower"  width="200" />
      <el-table-column label="实时电压" align="center" prop="rtVoltage"  width="200" />
      <el-table-column label="状态" align="center" prop="status" :formatter="statusFormat"  width="200" />
      <el-table-column label="上报时间" align="center" prop="createTime"  width="200" ></el-table-column>
